...
from tasks.background import alert_loop, reaper_loop, payment_recovery_loop
...
async def startup_event():
    ...
    app.state.payment_recovery_task = loop.create_task(
        coro=payment_recovery_loop(ocpp_integration)
    )
